...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <header class="navbar-header">
            ...
            <a href="index.php" class="navbar-brand"><img src="assets/img/305975246_480030324173600_4611494949818294877_n 1.png" alt="" style="width: 50px;">
            </a>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <ul class="nav navbar-nav">
                <li><a href="dashboard.php">Welcome to: UIC Alumni Tracer</a>
                </li>
...
<header class="head">
    ...
    <div class="main-bar">
        ...
        $qry = mysqli_query($con,"SELECT * FROM user_student_detail WHERE student_userID = '$login_id'");
        $res = mysqli_fetch_assoc($qry);
        $student_fName = isset($res['student_fName']) ? $res['student_fName'] : '';
        $student_lName = isset($res['student_lName']) ? $res['student_lName'] : '';
        $student_img = isset($res['student_img']) ? $res['student_img'] : '';

        // Now you can use $student_fName, $student_lName, $student_img as needed
        ?>
    </div>
    <!-- /.main-bar -->
</header>
