...
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Image('../../img/305975246_480030324173600_4611494949818294877_n 1.png',25,6,20);
$pdf->SetFont('Times','B',15);
$pdf->Cell(80);
$pdf->Cell(30,10,'UIC AlUMNI TRACER STUDY',0,1,'C');
$pdf->Cell(80);
...
$pdf->SetFont('Times','B',15);
$pdf->Cell(80);
$pdf->Cell(30,10,'UIC AULMNI TRACER STUDY',0,1,'C');
$pdf->Cell(80);
