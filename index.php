...
<head>
    ...
    <title>UIC</title>
    <link rel="shortcut icon" href="assets/img/305975246_480030324173600_4611494949818294877_n 1.png"/>
...
background: #ffb2d9; /* Old browsers */
background: -moz-linear-gradient(-45deg, #ffb2d9 0%, #ff66a3 13%, #ff99c2 29%, #ff66a3 46%, #ff99c2 47%, #ff66a3 49%, #ff99c2 65%, #ff99c2 83%, #ff3399 100%); /* FF3.6-15 */
background: -webkit-linear-gradient(-45deg, #ffb2d9 0%,#ff66a3 13%,#ff99c2 29%,#ff66a3 46%,#ff99c2 47%,#ff66a3 49%,#ff99c2 65%,#ff99c2 83%,#ff3399 100%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(135deg, #ffb2d9 0%,#ff66a3 13%,#ff99c2 29%,#ff66a3 46%,#ff99c2 47%,#ff66a3 49%,#ff99c2 65%,#ff99c2 83%,#ff3399 100%);/* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
...
<div id="dialogbox">
  <div>
    ...
    <div class="text-center">
        <img src="assets/img/305975246_480030324173600_4611494949818294877_n 1.png" alt="Metis Logo" style="width: 100px;">
                <h5>University Of Immaculate Conception</h5>
    ...
    <div class="text-center">
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <img src="assets/img/305975246_480030324173600_4611494949818294877_n 1.png" alt=" CvSU Tracer Study" style="width: 40px; margin-top: 6px; ">
          <a class="navbar-brand" href="#">Alumni Tracer</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav list-inline">
            <li class="active"><a href="#login-student" data-toggle="tab">Log-in</a></li>
            <li><a href="#" data-toggle="modal" data-target="#objective">Objective</a></li>
            <li><a href="#" data-toggle="modal" data-target="#goal">Goal</a></li>
            <li><a href="#" data-toggle="modal" data-target="#Overview">Overview</a></li>
            <li><a href="#" data-toggle="modal" data-target="#SystemDeveloper">Developer</a></li>
          </ul>
          </div><!--/.nav-collapse -->
      </div>
      <div class="bg-dark dker">
      <center>
          UIC ALUMNI TRACER SYSTEM <br>
All Rights Reserved
      </center>
      </div>
