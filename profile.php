...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    // Handle the case where $result doesn't contain any rows
    // You may set a default value for $data_img or display an error message
}
?>
    ...
    border-left-color: #ccc!important;">
                                  ...
                                  <div id="profile" class="tab-pane active" >
                                    <section class="panel">
                                      ...
                                      <h1>Bio Graph
    <a href="" class="pull-right btn btn-primary" data-toggle="modal" data-target="#test-modal">EDIT</a>
</h1>

<div class="row">
    <div class="bio-row">
        <img class="media-object img-thumbnail user-img" alt="User Picture" src="assets/img/profile_img/<?php echo isset($res_sidebar[$userType.'_img']) ? $res_sidebar[$userType.'_img'] : ''; ?>" style="width: 64px; height: 64px;">
    </div>
    <div class="bio-row"></div>
    <div class="bio-row">
        <p><span>Full Name </span>: <?php echo isset($res_sidebar[$userType.'_fName']) && isset($res_sidebar[$userType.'_mName']) && isset($res_sidebar[$userType.'_lName']) ? $res_sidebar[$userType.'_fName']." ".$res_sidebar[$userType.'_mName']." ".$res_sidebar[$userType.'_lName'] : ''; ?></p>
    </div>
    <div class="bio-row">
        <p><span>Address </span>: <?php echo isset($res_sidebar[$userType.'_address']) ? $res_sidebar[$userType.'_address'] : ''; ?></p>
    </div>
    <div class="bio-row">
        <p><span>Status</span>: <?php 
            if (isset($res_sidebar[$userType.'_civilStat'])) {
                ...
                echo isset($c_n['marital_Name']) ? $c_n['marital_Name'] : '';
            }
        ?></p>
    </div>
    <div class="bio-row">
        <p><span>Gender </span>: <?php 
            if (isset($res_sidebar[$userType.'_gender'])) {
    ...
    <div class="bio-row">
        <p><span>Mobile </span>: <?php echo isset($res_sidebar[$userType.'_contact']) ? $res_sidebar[$userType.'_contact'] : ''; ?></p>
    </div>
    <?php if ($userType == "student" && isset($res_sidebar[$userType.'_IDNumber'])) { ?>
    <div class="bio-row">
        <p><span>ID Number </span>: <?php echo $res_sidebar[$userType.'_IDNumber']; ?></p>
    </div>
    <?php } ?>
    <?php if ($userType == "student" && isset($res_sidebar[$userType.'_admission'])) { ?>
    <div class="bio-row">
    ...
    <div class="bio-row">
        <?php 
            if ($userType == "student" && isset($res_sidebar[$userType.'_department'])) {
                $z = mysqli_query($con,"SELECT cc.course_name FROM `user_student_detail` usd INNER JOIN cvsu_course cc ON usd.student_department = cc.course_ID WHERE student_ID = $login_id");
                $z = mysqli_fetch_array($z);
                echo isset($z['course_name']) ? $z['course_name'] : '';
            } elseif ($userType == "teacher" && isset($res_sidebar[$userType.'_department'])) {
